...
<head>
    ...
    <script type="text/javascript" src="backend/js/transport.js"></script>
    <style type="text/css">
        ...
        .explode {background: url(backend/images/menu_minus.gif) no-repeat 0px 3px; font-weight: bold;}
        .collapse { background: url(backend/images/menu_plus.gif) no-repeat 0px 3px; font-weight: bold;}
        .menu-item { background: url(backend/images/menu_arrow.gif) no-repeat 0px 3px; font-weight: normal;}
    ...
    <div id="tabbar-div">
        <p>
            <span style="float:right; padding: 3px 5px;">
                <a href="javascript:toggleCollapse();"><img id="toggleImg" src="backend/images/menu_minus.gif" width="9" height="9" border="0" alt="闭合"></a>
            </span>
            ...
            <ul id="menu-ul">
                <li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
                    <ul>
                          ...
                          <li class="menu-item"><a href="index.php?controller=backend/ProductCategory&action=index" target="main-frame">商品分类</a></li>
                          <li class="menu-item"><a href="index.php?controller=backend/ProductBrand&action=index" target="main-frame">商品品牌</a></li>
                          <li class="menu-item"><a href="index.php?controller=backend/ProductAttributeCategory&action=index" target="main-frame">商品类型</a></li>                
                          <li class="menu-item"><a href="index.php?controller=backend/Product&action=create" target="main-frame">添加新商品</a></li>
...
function toggleCollapse()
{
  ...
  collapse = !collapse;
  document.getElementById('toggleImg').src = collapse ? 'backend/images/menu_minus.gif' : 'images/menu_plus.gif';
...
Object.extend(ToggleHanlder ,{
  ...
  Load : function()
  {
    ...
    document.getElementById('toggleImg').src = collapse ? 'backend/images/menu_minus.gif' : 'backend/images/menu_plus.gif';
    document.getElementById('toggleImg').alt = collapse ? collapse_all : expand_all;
  }
});
