...
<div class="main-div">
  <form action="index.php?controller=backend/ProductAttribute&action=create" method="post" name="theForm">
  <table width="100%" id="general-table">
      ...
      <tr>
        ...
        <td>
          <input type="radio" name="attr_input_type" value="2" checked="true" onclick="radioClicked(0)">
          手工录入
          <input type="radio" name="attr_input_type" value="1" onclick="radioClicked(1)">
            从下面的列表中选择（一行代表一个可选值）
        </td>
      </tr>
      <tr>
