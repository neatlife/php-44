...
<div class="main-div">
<form method="post" action="index.php?controller=backend/ProductBrand&action=update&id=<?php echo $productBrand['id'] ?>" name="theForm" enctype="multipart/form-data" onsubmit="">
<table cellspacing="1" cellpadding="3" width="100%">
  ...
  <tr>
    ...
    <td>
		<input type="radio" <?php if($productBrand['is_show'] == '1'): ?>checked <?php endif; ?> name="is_show" value="1" > 是        
		<input type="radio" <?php if($productBrand['is_show'] == '0'): ?>checked <?php endif; ?>  name="is_show" value="0" > 否        (当品牌下还没有商品的时候，首页及分类页的品牌区将不会显示该品牌。)
    </td>
  </tr>
  <tr>
