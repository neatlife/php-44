...
<form method="post" action="index.php?controller=backend/User&action=login" name='theForm'>
  <table cellspacing="0" cellpadding="0" style="margin-top: 100px" align="center">
  <tr>
    <td><img src="backend/images/login.png" width="178" height="256" border="0" alt="ECSHOP" /></td>
    <td style="padding-left: 50px">
      ...
      <td colspan="2" align="right">
        <img src="index.php?controller=backend/User&action=captcha&random=<?php echo time() ?>" width="145" height="20" alt="CAPTCHA" border="1" onclick= this.src="index.php?controller=backend/User&action=captcha&random="+Math.random() style="cursor: pointer;" title="看不清？点击更换另一个验证码。" />
      </td>
      </tr>
