...
<head>
	...
	<link rel="stylesheet" href="frontend/css/base.css" type="text/css" />
	<link rel="stylesheet" href="frontend/css/shop_common.css" type="text/css" />
	<link rel="stylesheet" href="frontend/css/shop_header.css" type="text/css" />
        <link rel="stylesheet" href="frontend/css/shop_home.css" type="text/css" />
        <script type="text/javascript" src="frontend/js/jquery.js" ></script>
        <script type="text/javascript" src="frontend/js/topNav.js" ></script>
        <script type="text/javascript" src="frontend/js/focus.js" ></script>
        <script type="text/javascript" src="frontend/js/shop_home_tab.js" ></script>
</head>
<body>
	...
	<div class="shop_hd">
		...
		<div class="shop_hd_header">
			<div class="shop_hd_header_logo"><h1 class="logo"><a href="/"><img src="frontend/images/logo.png" alt="ShopCZ" /></a><span>ShopCZ</span></h1></div>
					...
					<ul class="shop_hd_menu_all_category_hd_menu clearfix">
						...
						<?php foreach($productCategorys as $productCategory): ?>
							<li id="cat_<?= $productCategory['id'] ?>" class="">
								<h3><a href="" title="<?= $productCategory['name'] ?>"><?= $productCategory['name'] ?></a></h3>

								<div id="cat_<?= $productCategory['id'] ?>_menu" class="cat_menu clearfix" style="">
									<?php foreach($productCategory['childrens'] as $item): ?>
											<dl class="clearfix">
												<dt><a href="<?= $item['name'] ?>" href=""><?= $item['name'] ?></a></dt>

												<dd>
													<?php foreach($item['childrens'] as $value): ?>
					                                	<a href=""><?= $value['name'] ?></a>
													<?php endforeach; ?>
												</dd>
											</dl>
	...
	<div class="shop_bd clearfix">
            ...
            <div class="shop_bd_top clearfix">
                ...
                <div class="shop_bd_top_center">
                    ...
                    <div class="xifan_sub_box">
                      ...
                      <div id="xifan_bd1lfimg">
                        <div>
                          <dl class=""></dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="frontend/images/e2dfe57add8fff66ed0964b1effd39b9.jpg" alt="2011城市主题公园亲子游"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">2011城市主题公园亲子游</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="frontend/images/e50b5d398e3b890f08e14defbc71a94d.jpg" alt="潜入城市周边清幽之地"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">潜入城市周边清幽之地</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="frontend/images/196b173f15685a2019ab3396cd1851a4.jpg" alt="盘点中国最美雪山"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">盘点中国最美雪山</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="frontend/images/e81345cbc3d8a7e11f9a0e09df68221d.jpg" alt="2011西安世园会攻略"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">2011西安世园会攻略</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="frontend/images/65662b58848da87812ba371c7ff6c1ad.jpg" alt="五月乐享懒人天堂塞班岛"></a></dt>
                    ...
                    <!-- 图片切换  end --> 
                    <div class="clear"></div>
                    <div class="shop_bd_top_center_hot"><img src="frontend/images/index.guanggao.png" /></div>
                </div>
            ...
            <div class="shop_bd_2 clearfix">
                ...
                <div class="shop_bd_tuijian">
                    <ul class="tuijian_tabs">
                        ...
                        <li onmouseover="easytabs('1', '2');" onfocus="easytabs('1', '2');" onclick="return false;" id="tuijian_content_btn_2" >
                        	<a href="javascript:void(0);">新品上架</a>
                        </li>
                    </ul>
                        ...
                        <div id="tuijian_content_1" class="tuijian_shangpin" style="display: block;">
                            <ul>
                            	<?php foreach($specialProducts as $specialProduct): ?>
	                                <li>
	                                    <dl>
	                                        <dt><a href=""><img src="upload/<?= $specialProduct['image_path'] ?>" /></a></dt>
	                                        <dd><a href=""><?= $specialProduct['name'] ?></a></dd>
	                                        <dd> 商城价：<em><?= $specialProduct['shop_price'] ?></em>元</dd>
	                                    </dl>
	                                </li>
                                <?php endforeach; ?>
                            </ul>
                        ...
                        <div id="tuijian_content_2" class="tuijian_shangpin">
                            <ul>
                            	...
                            	<?php foreach($newProducts as $newProduct): ?>
	                                <li>
	                                    <dl>
	                                        <dt><a href=""><img src="upload/<?= $newProduct['image_path'] ?>" /></a></dt>
	                                        <dd><a href=""><?= $newProduct['name'] ?></a></dd>
	                                        <dd> 商城价：<em><?= $newProduct['shop_price'] ?></em>元</dd>
	                                    </dl>
	                                </li>
                                <?php endforeach; ?>
                            </ul>
                ...
                <!-- 首发 -->
                <div class="shop_bd_shoufa"><img src="frontend/images/shoufa.jpg" /></div>
                <!-- 首发 End -->
            ...
            <div class="shop_bd_home_block clearfix">
                ...
                <div class="shop_bd_home_block_left">
                    ...
                    <div class="shop_bd_home_block_left_pic">
                        <a href=""><img src="frontend/images/web-1-13_53bfbfc958cb55a435545033bd075bf3.png"/></a>
                    </div>
                </div>
                <!-- 左边 End -->
                ...
                <div class="shop_bd_home_block_center">
                    ...
                    <div class="tabs-panel">
                        <ul>
                            <li>
                                <dl>
                                    <dt><a href=""><img src="frontend/images/04fb225ea46bd1346f330400eedb7ef2.jpg_small.jpg" /></a></dt>
                ...
                <div class="shop_bd_home_block_right">
                    ...
                    <ol class="saletop-list">
                        <li class="top clearfix">
                            <dl>
                                ...
                                <dd class="nokey">1</dd>
                                <dd class="goods-pic">
                                    <a href=""><span class="thumb size60"><img src="frontend/images/3f81874d594894d19150843c42fb1f8e.jpg_small.jpg" /></span></a>
                                </dd>
                    ...
                    <div class="saletop-list_adv_pic"><a href=""><img src="frontend/images/web-3-38_ff9bd2d724f7138cec1b1937000f4feb.jpg" /></a></div>
                </div>
                <!-- 右边商品排行 -->
                ...
                <div class="shop_bd_home_block_bottom">
                    <ul class="">
                        <li><a href=""><img src="frontend/images/354b80528d2fbeefbab33c563532517e.gif" /></a></li>
                        <li><a href=""><img src="frontend/images/1d2dfbead590510046a6522551db8139.gif" /></a></li>
                        <li><a href=""><img src="frontend/images/26247430b09daa1b441b46008bfb6e6e.gif" /></a></li>
                        <li><a href=""><img src="frontend/images/a0ac8c6d2d3dc1470d5876923182a8e2.gif" /></a></li>
                        <li><a href=""><img src="frontend/images/9c5dee77a6ecdafd9e152fed8c6a4e90.gif" /></a></li>
                        <li><a href=""><img src="frontend/images/b175883eba95e793affb1b1ebbbf85a5.gif" /></a></li>
                        <li><a href=""><img src="frontend/images/6e61a1c953e5bc8c5f1ffdac36862245.gif" /></a></li>
                        <li><a href=""><img src="frontend/images/209abd835cd2ce2208f2dc42ba10efb4.gif" /></a></li>
                    </ul>
                </div>
                <!-- 品牌展示 End -->
