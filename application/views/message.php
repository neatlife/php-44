...
<meta http-equiv="Refresh" content ="<?php echo $waitSecond;?> ;url=<?php echo $url;?>"/>
  ...
  <div style="background:#FFF; padding: 20px 50px; margin: 2px;">
    <table align="center" width="400">
      <tr>
        ...
        <!--  <img src="backend/images/information.gif" width="32" height="32" border="0" alt="information" /> -->
          <img src="backend/images/warning.gif" width="32" height="32" border="0" alt="warning" />
       <!--   <img src="backend/images/confirm.gif" width="32" height="32" border="0" alt="confirm" /> -->
        </td>
