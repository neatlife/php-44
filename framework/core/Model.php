...
class Model{
	...
	public function __construct($table){
		$dbconfig['host'] = $GLOBALS['database']['host'];
		$dbconfig['user'] = $GLOBALS['database']['user'];
		$dbconfig['password'] = $GLOBALS['database']['password'];
		$dbconfig['dbname'] = $GLOBALS['database']['dbname'];
		$dbconfig['port'] = $GLOBALS['database']['port'];
		$dbconfig['charset'] = $GLOBALS['database']['charset'];
		
		$this->db = new Mysql($dbconfig);
		$this->table = $GLOBALS['database']['prefix'] . $table;
